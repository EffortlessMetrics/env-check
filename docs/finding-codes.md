...
Before comparison, CLI output is normalized:
- `v20.11.0` → `20.11.0` (v-prefix stripped)
- `20` → `20.0.0` (zero-filled)
- `git version 2.43.0` → `2.43.0` (prefix extracted)
- Prerelease/build metadata preserved: `1.2.3-rc.1` stays as-is

See [Version Normalization](parsers.md#version-normalization) for full details.
