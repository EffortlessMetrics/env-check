...
| `env-check-cli` | Clap CLI (`check`, `md`, `explain`, `completions`) |
...
```bash
env-check completions bash   # bash
env-check completions zsh    # zsh
env-check completions fish   # fish
...
- [Configuration Reference](docs/configuration.md) - Normative configuration schema, field reference, and example configs
